...
const scoreTopLeft = document.querySelector('#scoreSpan')
...
let player, AnimId, score = 0, highScore = 0, playerName
...
const PARTICLE_NO_MULTIPLIER = 5 // Number of particles = radius of enemy
